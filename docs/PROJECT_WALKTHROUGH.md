# Project Walkthrough / 项目讲解指南

本文档用于快速复盘项目架构、核心链路和质量护栏。建议展示顺序：README -> 本地 UI -> 架构图 -> RAG eval -> 关键代码 -> 测试与日志。发布到 GitHub 前，先按 `docs/OPEN_SOURCE_CHECKLIST.md` 做一次公开仓库安全检查。
