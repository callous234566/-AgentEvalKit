# Sanitized Sample Data / 脱敏示例资料

本文件记录公开 GitHub 版本推荐使用的脱敏示例资料和快速体验路线。示例资料不包含真实 Chroma、日志、缓存、密钥、私有知识库正文或真实 eval report。
